...
public class HomeController {
	...
	static LinkedHashMap<String,String> roleOptions;
	static {
		roleOptions = new LinkedHashMap<>();
		roleOptions.put("ADMIN", "Admin");
		roleOptions.put("USER", "User");
		roleOptions.put("HR", "Human Resource");
		roleOptions.put("ACCOUNT", "Accounts");
	}
	...
	public String addEmployee(Model model) {
		...
		System.out.println(roleOptions);
		return "addEmployee";
	}
